...
dprice['ym'] = dprice['date'].apply(lambda x:x.year*100 + 6 if x.month > 7 else  (x.year - 1)*100 + 6)
...
exf = pd.ExcelFile('data\股票样本因子数据20210212.xlsx')
...
ffdf = dprice.merge(ofacts,on=['code','ym'],how='left')
